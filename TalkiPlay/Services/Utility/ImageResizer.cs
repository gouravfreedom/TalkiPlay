...
namespace TalkiPlay
{
    public static class ImageResizer
    {
        ...
        public static ImageSource ResizeImageToFitDevice(string file)
        {
            var assembly = typeof(TalkiPlay.App).GetTypeInfo().Assembly;
            byte[] imageData;
            ...
            byte[] resizedImage = ImageResizer.ResizeImage(imageData, (float)di.Width, (float)di.Height);
