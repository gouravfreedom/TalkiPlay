...
namespace TalkiPlay
{
    ...
    public class WrapLayout : Layout<View>
    {
        ...
        public static readonly BindableProperty VerticalContentAlignmentProperty = BindableProperty.Create(
            ...
            typeof(WrapLayoutContentAlignment),
            typeof(WrapLayout),
            WrapLayoutContentAlignment.Default);
        ...
        public WrapLayoutContentAlignment HorizontalContentAlignment
        {
            get => (WrapLayoutContentAlignment)GetValue(HorizontalContentAlignmentProperty);
        ...
        public WrapLayoutContentAlignment VerticalContentAlignment
        {
            get => (WrapLayoutContentAlignment)GetValue(VerticalContentAlignmentProperty);
        ...
        {
            // Check for data
            if (ItemsSource == null || ItemsSource is IList i && i.Count == 0)
            {
                return;
            }
