...
namespace TalkiPlay
{
    public class GuideChildSelectionPage : SimpleBasePage<GuideChildSelectionPageViewModel>
    {
        public GuideChildSelectionPage()
        {
            BuildContent();
        }
        ...
        void BuildContent()
        {
            ...
            navView.LeftButton.SetBinding(ImageButtonView.CommandProperty,
                nameof(ViewModelType.BackCommand));
            ...
            var collectionView = new CollectionView()
            {
                ...
                ItemTemplate = new DataTemplate(() =>
                {
                    ...
                    BindableLayout.SetItemTemplate(layout,
                        new DataTemplate(typeof(GuideChildView)));
                    return layout;
                }),
                EmptyView = emptyView
            };
            ...
            //     },
            //     ItemTemplate = new DataTemplate(typeof(GuideChildView)),
            //     EmptyView = emptyView
            //     
            // };
            // collectionView.SetBinding(ItemsView.ItemsSourceProperty, nameof(ViewModelType.Items));
