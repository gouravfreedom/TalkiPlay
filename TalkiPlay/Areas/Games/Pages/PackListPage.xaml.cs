...
namespace TalkiPlay
{
    public partial class PackListPage :  BasePage<IPackPageViewModel>, IAnimationPage
    {
        ...
        public PackListPage()
        {
            ...
            ItemGroupList.On<Xamarin.Forms.PlatformConfiguration.iOS>().SetSeparatorStyle(SeparatorStyle.FullWidth);
            ItemGroupList.On<Xamarin.Forms.PlatformConfiguration.Android>().SetIsFastScrollEnabled(false);
            ...
            this.WhenActivated(d =>
                {
                    ...
                    this.OneWayBind(ViewModel, v => v.ItemGroups, view => view.ItemGroupList.ItemsSource).DisposeWith(d);
