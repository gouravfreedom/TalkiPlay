...
namespace ChilliSource.Mobile.UI.ReactiveUI.iOS
{
    ...
    public class HackedPageRenderer : PageRenderer
    {
        ...
        private IBasePageController BasePageController => Element is NavigationPage ? (Element as NavigationPage).CurrentPage as IBasePageController : Element as IBasePageController;
